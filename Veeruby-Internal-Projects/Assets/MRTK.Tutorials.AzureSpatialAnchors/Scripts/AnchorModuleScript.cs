...
public class AnchorModuleScript : MonoBehaviour
{
    ...
    private CoarseRelocalizationSettings coarseRelocalizationSettings;
    ...
    {
        await this.StartAzureSessionAsync();
    }
    ...
    {
        await this.StopAzureSessionAsync();
    }
    ...
    {
        await this.StartAzureSessionForCoarseRelocalizationAsync();
    }
    ...
    public async Task RestartSession(bool useCoarseRelocalization)
    {
        if (this.SessionStarted)
        {
            this.StopAzureSession();
        }
